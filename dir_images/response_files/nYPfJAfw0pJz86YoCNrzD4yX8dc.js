;if(CloudflareApps.matchPage(CloudflareApps.installs['86CBXEeWSE96'].URLPatterns)){(function(){"use strict"
if(!window.addEventListener)return
var options=CloudflareApps.installs['86CBXEeWSE96'].options
var element
...
return max}
function inIframe(){try{if("86CBXEeWSE96"==='preview'){return window.top!==window.parent.parent}
...
let isConsent=!((!inIframe())&&("86CBXEeWSE96"==='preview'||((localStorageValid===false)||(localStorageValid===undefined))));if(!((options.callbackFunction=="")||(options.callbackFunction==null))){window.onload=function(){let fn=window[options.callbackFunction]
...
elementButton.onclick=function(){if("86CBXEeWSE96"!='preview'){let fn=window[options.callbackFunction]
...
window.CloudflareApps.installs['86CBXEeWSE96'].scope={setOptions:function setOptions(nextOptions){options=nextOptions
